  ...
  return (
    <Container>
      ...
      >
        ...
        <p>
          Like any other website, fotbollsträning.se uses 'cookies'. These
        ...
        <p>
          fotbollsträning.se's Privacy Policy does not apply to other
        ...
        <p>
          fotbollsträning.se does not knowingly collect any Personal
